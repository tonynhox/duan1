...
class TrangThaiDonHangAdmim extends RecyclerView.Adapter<TrangThaiDonHangAdmim.ViewHolder> {

        ArrayList<TrangThai>list;
        Context context;

    public TrangThaiDonHangAdmim(ArrayList<TrangThai> list, Context context) {
        this.list = list;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            ivLon = itemView.findViewById(R.id.ivSanPham);
